...
import RouterDetailItem from "../RouterDetailItem";
/**
 * 
 * @param {data} items 数据
 * 
...
export default function index(props) {
  ...
  return items && items.map((item, i) => /*#__PURE__*/React.createElement(RouterDetailItem, _extends({}, item, {
    key: i
  })));
}